...
router.get('/hoops_entity/:place_id/parking/:park_id', capstone.getParkingID);
...
router.post('/hoops_entity/edit/:place_id', capstone.editHoopsEntity);
/* POST localhost:8080/capstone/edit/? => Edit data parking */
router.post('/parking/edit/:park_id', capstone.editParking);

/* POST localhost:8080/capstone/delete/? => Delete data hoops_entity */
router.post('/hoops_entity/delete/:place_id', capstone.deleteHoopsEntityID);
/* POST localhost:8080/capstone/delete/? => Delete data parking */
router.post('/parking/delete/:park_id', capstone.deleteParkingID);
